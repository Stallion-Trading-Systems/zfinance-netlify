                                                                                ...
                                                                                <div className="row g-5" >
                                                                                    <div className="col-6">
                                                                                        ...
                                                                                        <select onChange={(e) => { setError({ ...error, vesting_details: false });setDetails({ ...details, "vesting_details": e.target.value })  }} style={{ height: "39px" }} className={(error?.vesting_details) ? "new-input-css-2 ml-3 input-error-css" : "new-input-css-2 mb-5 ml-3"} name="vd" id="vd">
                                                                                            ...
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="1/48 monthly, 1yr cliff">1/48 monthly, 1yr cliff</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="1/48 monthly, no cliff">1/48 monthly, no cliff</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="1/60 monthly, 1yr cliff">1/60 monthly, 1yr cliff</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="1/60 monthly, no cliff">1/60 monthly, no cliff</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="1/36 monthly, 1yr cliff">1/36 monthly, 1yr cliff</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="1/36 monthly, no cliff">1/36 monthly, no cliff</option>
