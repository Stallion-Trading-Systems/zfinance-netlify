                                                                                ...
                                                                                <div className="row g-5" >
                                                                                    <div className="col-6">
                                                                                        ...
                                                                                        <select onChange={(e) => { setError({ ...error, vesting_details: false });setDetails({ ...details, "vesting_details": e.target.value })  }} style={{ height: "39px" }} className={(error?.vesting_details) ? "new-input-css-2 ml-3 input-error-css" : "new-input-css-2 mb-5 ml-3"} name="vd" id="vd">
                                                                                            ...
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="volvo">Volvo</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="saab">Saab</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="mercedes">Mercedes</option>
                                                                                            <option onChange={(e) => { setError({ ...error, vesting_details: false }); setDetails({ ...details, "vesting_details": e.target.value }) }} value="audi">Audi</option>
                                                                                        </select>
